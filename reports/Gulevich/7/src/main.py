...
class RotatingLineApp:
    def __init__(self, parent_window):
        ...
        self.parent_window.title("Вращающийся отрезок")
        ...
        # Создание холста
        self.canvas = tk.Canvas(parent_window, width=800, height=600, bg="white")
        self.canvas.pack()
    ...
    def create_controls(self):
        control_frame = ttk.Frame(self.parent_window)
        ...
        coord_frame = ttk.Frame(self.parent_window)
    ...
    def animate(self):
        if not self.is_paused:
            ...
            if self.point_position > 1:
                self.point_position = 0
            self.draw_line()
        self.parent_window.after(16, self.animate)
...
if __name__ == "__main__":
    parent_window = tk.Tk()
    app = RotatingLineApp(parent_window)
